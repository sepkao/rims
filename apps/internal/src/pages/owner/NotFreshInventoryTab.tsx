...
export default function NotFreshInventoryTab() {
  ...
  // แยกทิ้งได้ 2 ทาง: กดยืนยันตรงนี้ (dispose, บังคับกรอกเหตุผล) หรือปล่อยให้ scan ของแท็บ "รายการรอตรวจ"
  ...
  return (
    <>
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <p className="text-sm text-[#7B726B]">ของที่หมดอายุไปแล้วจริง ยังนั่งอยู่ในคลัง — กดแยกทิ้งได้ตรงนี้เลย</p>
        <input value={query} onChange={(event) => setQuery(event.target.value)} placeholder="Search ingredients..." className="admin-control w-full rounded-md border-none bg-[#F4EFEA] px-4 py-2.5 text-sm sm:w-[320px]" />
      </div>
